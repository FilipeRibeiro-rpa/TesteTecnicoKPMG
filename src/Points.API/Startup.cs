...
using Points.API.Application.DI;
using MediatR;
...
namespace Points.API
{
    public class Startup
    {
        ...
        {
            Initializer.Configure(services, Configuration.GetConnectionString("DefaultConnection"), int.Parse(Configuration["CheckUpdateTimeService"].ToString()));
